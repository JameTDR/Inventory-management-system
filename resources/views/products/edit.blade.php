            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="small mb-1" for="product_name">Produk Name <span class="text-danger">*</span></label>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="category_id">Category <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="unit_id"> <span class="text-danger">*</span></label>
